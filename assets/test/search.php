                            ...
                            <tbody>
                                <?php 
                                    ...
                                    if(isset($_GET['search']))
                                    {
                                        ...
                                        $query = "SELECT * FROM complaint WHERE CONCAT(UserName,Contact_number,Comp_Date,Location,Problem_Observed,Problem_Desc,Comp_Status,Rectified_by_person,Remarks) LIKE '%$filtervalues%' ";
