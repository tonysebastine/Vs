...
tt=display_c();
	...
	<center><font size="6" color="#fff" style="font-family:Footlight MT Light;margin-top:0px"><b>PrintStudio India PVT LTD<br></font></center></b> 
	...
	if ($numrows1 !=0)
					{
						echo "<tr>";
							while($row=mysqli_fetch_assoc($result1))  
							{
								...
								<td bgcolor=#fff><TExTAREA ROWs ='2' COLS='20' NAME='prob_desc'readonly>".$row['Problem_Desc']."</textarea></td>	
								...
								echo "<td bgcolor=#fff><TExTAREA ROWs ='2' COLS='20' NAME='Problem_Observed'readonly>".$row['Problem_Observed']."</textarea></td>";
								echo "<td bgcolor=#fff><TExTAREA ROWs ='2' COLS='20' NAME='Rectified_by_process'readonly>".$row['Rectified_by_process']."</textarea></td>";
								...
								echo "<TD bgcolor=#fff ><a href='closecomp.php?refno=".$row['serialNumber']."'>CLOSE</a></td></TR>";							
...
//echo "<tr><TD colspan =16 ><center><a href='logout.php'>LOG OUT</a></center></td></TR>";	
}
...
?>
	 ...
	 <a href="AMC LIST 2021.html">AMC ASSET DATA</a><br> 
	 

    <a href="https://10.19.8.13/index.php">Previous page</a><br> </br>
