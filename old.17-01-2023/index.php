...
<body oncontextmenu="return false;">
    ...
    <div class="main">
        <div class="navbar">
            <div class="icon">
                <h1 class="logo" img src="PCAMC/logo.jpg"></h1>
				<img src="PCAMC/images/logo.jpg" alt="ecil" style="width:150px">
            </div>
   ...
   <font color="#fff" font size=8 font-family="Bookman Old Style">Electronics Corporation Of India Limited</center>
           ...
           <div class="menu">
                <ul>
                    ...
                    <li><a href="PCAMC/ENGINEER.PDF">ENIGNEER_NUMBER</a></li>
