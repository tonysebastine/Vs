...
<body oncontextmenu="return false" onLoad="noBack();" onpageshow="if (event.persisted) noBack();" onUnload="">
 ...
 <div class='head'>
 <h1 class='company'>View Status </h1>
  ...
  <input type="password" placeholder='••••••••••••••' class='password'><br>-->
					...
					<button class="btn-login" input type="submit" name="submit" style="margin:20px;">
                    Login</button>      
                    <a href="https://support.printstudio.in" button class="btn-login" input type="submit">Home Page</a>
                    <font color="#fff" style="margin:20px;></a></button></font>
