...
$mail->Username   = "printstudio225@gmail.com";
$mail->Password   = "igvwkvffdykitlxe";
//recipient
$mail->AddAddress($email);
$mail->SetFrom("support@printstudio.in","Printstudio Pvt.Ltd");
$mail->AddReplyTo("support@printstudio.in","Printstudio Pvt.Ltd");
						...
						$message = "Compliant Logged  Ref num :".$sernumber."<BR>Your complaint will be attended Soon... <BR> This is Autogenerated_mail from Computer AMC  <br><br>
								<br></br><br></br><br></br> <b><font color=#d209d9>Thanks & Regards,<br></br>Desktop Support Engineer <br>Annual Maintenance Contract (AMC) <br>PrintStudio<br></b></font>";
							$mail->Body  = $message;
